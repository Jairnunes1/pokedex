...
const coracoes = {
  heartRED:
    '<img src="./Img/svgs/Red-Like-Icon-09uh.svg" alt="" width="24px" height="24px"></img>',
  heartGREY:
...
function processarInput(dados) {
  ...
  if (dados.stats[0].base_stat < 20) {
    heart.innerHTML =
      coracoes.heartRED.repeat(1) + coracoes.heartGREY.repeat(4);
  } else if (dados.stats[0].base_stat < 41) {
    heart.innerHTML =
      coracoes.heartRED.repeat(2) + coracoes.heartGREY.repeat(3);
  } else if (dados.stats[0].base_stat < 61) {
    heart.innerHTML =
      coracoes.heartRED.repeat(3) + coracoes.heartGREY.repeat(2);
  } else if (dados.stats[0].base_stat < 81) {
    heart.innerHTML =
      coracoes.heartRED.repeat(4) + coracoes.heartGREY.repeat(1);
  } else if (dados.stats[0].base_stat <= 100) {
    heart.innerHTML = coracoes.heartRED.repeat(5);
  }
